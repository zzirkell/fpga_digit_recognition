...
weights_file = WEIGHTS_DIR / "int8_weights_from_float.npy"

if not weights_file.exists():
    raise FileNotFoundError(
        "int8_weights_from_float.npy not found. "
        "Run the fixed-point Python experiment first."
    )
...
image_file = MEM_DIR / "expA_image_0.mem"
...
for neuron in range(NUM_OUTPUTS):
    weight_file = MEM_DIR / f"expA_weights_{neuron}.mem"
...
expected_file = MEM_DIR / "expA_expected.txt"
