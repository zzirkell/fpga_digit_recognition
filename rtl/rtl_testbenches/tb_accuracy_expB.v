...
module tb_accuracy_expB;
    ...
    initial begin
        $readmemh("expB_test_labels_10000.mem", all_labels);
        $readmemh("expB_python_predictions_10000.mem", python_predictions);

        image_file = $fopen("expB_test_images_10000.mem", "r");
    ...
    initial begin
        ...
        $fclose(image_file);
        $display("");
        $display("EXPERIMENT B - FULL RTL TEST");
